...
- Gain hands-on experience in **Linux Administration** and **Virtualization**
- Combine technical skills with creative design to build user-friendly solutions
- Build a strong portfolio to present to future employers and clients
...
| Category | Skills |
|----------|--------|
| **System Servicing** | Computer Systems Servicing NCII, Hardware Troubleshooting |
| **IT Support** | IT Customer Support, Technical Assistance |
| **Operating Systems** | Windows, Linux Basics |
| **Programming** | Python (Essentials) |
| **Hardware** | Computer Hardware Basics |
| **Creative** | Video Editing, Graphics Design |
